<?php include "inc/header.php"; ?>
    ...
    <!-- Masthead -->  
    <main id="home" class="masthead jarallax" style="background-image:url('img/news/news-single.jpg');" role="main">
      <div class="opener">
        <div class="container">
          <div class="row">
     ...
     <div class="container">
        ...
        <div class="mt-5 pt-5">
          ...
          if(isset($_GET['id'])) {
            ...
            ?>      
            <div class="col-news col-md-12 col-lg-12" data-aos="fade-in" data-aos-delay="200">
              <figure class="position-relative">
                ...
                <figcaption><h5><a href="post.php?id=<?php echo $news['id']; ?>"><?php echo $news['title']; ?></a></h5><?php echo $news['description']; ?>
                </figcaption>
              </figure>
            </div>
