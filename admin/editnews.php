...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <h1>Edit News</h1>
        <form action="action/editnews.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt-4">
                    <img width="250" src="../img/news/<?php echo $result['image']; ?>" alt="">
                </div>
                <div class="col-md-12">
            ...
            <input class="btn btn-primary mt-3" name="submit" type="submit" value="Edit News">
        </form>
