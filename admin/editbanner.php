...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        <h1>Edit Banner</h1>
        <form action="action/editbanner.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt-4">
                    <img width="250" src="../img/banners/<?php echo $result['image']; ?>" alt="">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input value="<?php echo $result['button']; ?>" name="button" type="text" class="form-control" id="button">
                </div>
            </div>
            <input class="btn btn-primary mt-3" name="submit" type="submit" value="Edit Banner">
        </form>
