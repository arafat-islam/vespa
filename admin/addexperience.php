...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <form action="action/addexperience.php" method="post">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input name="date" type="date" class="form-control" id="image">
                </div>
            </div>
            <input class="btn btn-primary mt-3" name="submit" type="submit" value="Add Experience">
        </form>
