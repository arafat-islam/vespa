...
$deactive_current_active_services =  "UPDATE services SET status = 0 WHERE id = $id";

if($db->update($deactive_current_active_services)) {
    $_SESSION['deactive'] = "Services Deactivated!";
